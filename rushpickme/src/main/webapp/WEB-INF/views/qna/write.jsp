	...
	<div style="text-align: center; margin-top: 50px; margin-bottom: 20px;">
		<c:choose>
			<c:when test="${param.qnaTarget == null}">
				<input type="text" name="qnaTitle" required class="title-input" placeholder="제목을 입력하세요">
			</c:when>
			<c:otherwise>
				<input type="text" name="qnaTitle" required class="title-input" value="[Re] ${targetDto.qnaTitle}" placeholder="제목을 입력하세요">
			</c:otherwise>
		</c:choose>
	</div>
		...
		--%>
        <div class="cell">
            <textarea name="qnaContent" required></textarea>
        </div>
