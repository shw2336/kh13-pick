...
<script type="text/javascript">
	...
	$(function(){
		...
		$(".qna-like").find(".fa-heart").click(function(){
			$.ajax({
				url : "/rest/qna_like/toggle",//같은 서버이므로 앞 경로 생략
				method : "post",
				data : { qnaNo : qnaNo },
				success : function(response){
