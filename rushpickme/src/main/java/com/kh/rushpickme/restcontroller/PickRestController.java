...
public class PickRestController {
	...
	public List <PickFinishRestVo> finishListOrderBy  (@RequestParam String orderBy, HttpSession session, PageVO pageVo, Model model) {
		String loginId = (String)session.getAttribute("loginId");
		int count = pickDao.countFinish(loginId);
		pageVo.setCount(count);
		List <PickFinishRestVo> finishListOrderBy = null;
